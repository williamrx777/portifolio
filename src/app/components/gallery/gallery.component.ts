...
export class GalleryComponent implements OnInit{
  ...
  description2:string = 'Parking spot ou Vaga de estacionamento foi feito destinado a cadastrar pessoa seu carro seu expectiva vaga. Tecnologia usada foi springboot usando springsecurity para apenas o admin possa acessa documentação e fazer post update e delete e o get foi feito com paginação e o banco de dados usado e o postgresql.'
  link2:string = 'https://parking-spot-umber.vercel.app/'
  constructor() {
